...
func main()  {
	...
	phloOut , err := client.Phlos.Get("ebee832f-6467-4e9f-b168-4f296cbc2f09")
	if err != nil {
		panic(err)
	}
	//fmt.Println(phloOut)
	...
	phloRun, err := phloOut.Run()

	fmt.Printf("%# v", pretty.Formatter(phloRun))

	//nodeOut,err := phloOut.Node("ebee832f-6467-4e9f-b168-4f296cbc2f09","multi_party_call","8293c88b-afe2-4a05-988b-3f85668c4a67")
	//if err != nil {
	//	panic(err)
	//}
