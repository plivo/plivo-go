...
func (service *CallService) UpdateMaskingSession(params UpdateMaskingSessionParams, sessionId string) (response *UpdateMaskingSessionResponse, err error) {
...
func (service *CallService) GetMaskingSession(sessionId string) (response *GetMaskingSessionResponse, err error) {
...
func (service *CallService) ListMaskingSession(params ListSessionFilterParams) (response *ListMaskingSessionResponse, err error) {
